 ...
 * along with this program. If not, see <http://www.gnu.org/licenses/>.
 */
package com.theminequest.common.quest.event;
...
public interface EventManager {
	...
	void addEvent(String eventname, Class<? extends QuestEvent> event);
	
	QuestEvent constructEvent(String eventname, QuestTask task, int eventID, String[] arguments);
